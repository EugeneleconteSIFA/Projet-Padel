...
/* =============================================================================
   ...
   Importé via next/dynamic (ssr: false) dans tournaments-client.tsx.
   ============================================================================= */
...
/* Recadre automatiquement la carte sur les marqueurs visibles */
...
export function TournamentMap({ tournaments }: { tournaments: Tournament[] }) {
